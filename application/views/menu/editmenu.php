            ...
            <div class="row row-lg">
              <div class="col-md-12 col-lg-12">
                ...
                <div class="example-wrap">
                  <div class="example">
                    <form class="form-horizontal" method="post" action="<?php echo site_url('barang/edit_menu')?>">
                      <div class="form-group row form-material row">
                        <label class="col-md-3 form-control-label">Kode Barang : </label>
                        <div class="col-md-9">
                          <input type="text" 
                          class="form-control" name="id_menu" value="<?php echo $row->id_menu;?>" 
                          />
                        </div>
                      </div>
                      <div class="form-group row form-material row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="menu" placeholder="Menu"
                            autocomplete="off" value="<?php echo $row->menu;?>" />
                        </div>
                      </div>
                      <div class="form-group row form-material row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="harga" placeholder="Harga"
                            autocomplete="off" value="<?php echo $row->harga;?>" />
                        </div>
                      </div>
                      <div class="form-group row form-material row">
