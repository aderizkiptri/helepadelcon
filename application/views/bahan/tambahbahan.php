            ...
            <div class="row row-lg">
              <div class="col-md-12 col-lg-12">
                ...
                <div class="example-wrap">
                  <div class="example">
                    <form class="form-horizontal" method="post" action="<?php echo site_url('Bahan/tambah_bahan')?>">
                      <div hidden class="form-group row form-material row">
                        <label class="col-md-3 form-control-label">Id Bahan : </label>
                        <div class="col-md-9">
                          <input hidden type="text" 
                          class="form-control" name="id_bahan" placeholder="Kode" 
                          />
                        </div>
                      </div>
                      <div class="form-group row form-material row">
                        <label class="col-md-3 form-control-label">Nama Bahan : </label>
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="nama_bahan" placeholder="Bahan"
                            autocomplete="off" />
                        </div>
                      </div>
                      <div class="form-group row form-material row">
                      ...
                      <div class="form-group row form-material row">
                        <label class="col-md-3 form-control-label">Satuan </label>
                        <div class="col-md-9">
