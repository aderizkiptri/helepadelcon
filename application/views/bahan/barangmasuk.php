        ...
        <div class="panel">
          <div class="panel-body">
            <div class="row">
              <div class="col-md-6">
                <div class="mb-15">
                  <a href="<?php echo base_url();?>index.php/Bahan/tambah"class="btn btn-primary"> Tambah Bahan</a>
                </div>
              </div>
            </div>
            <table class="table table-bordered table-hover table-striped" cellspacing="0" id="exampleAddRow">
              ...
              foreach($bahan as $row) : ?>
                <tr class="gradeA">
                  <td hidden><?php echo $row->id_bahan; ?></td>
                  <td><?php echo $row->nama_bahan; ?></td>
                  <td><?php echo $row->stock; ?></td>
                  <td><?php echo $row->satuan; ?></td>

                  <td>
                    <a href="<?php echo site_url('Barang/edit_menu/'.$row->id_bahan);?>"><i class="icon md-edit"></i></a> | <a href="<?php echo site_url('Bahan/hapus_bahan/'.$row->id_bahan);?>"
